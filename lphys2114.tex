...
\titleformat{\section}
{\newpage\stepcounter{secshift}
\ifx\secshift>4\setcounter{secshift}{0}\fi \Large\sffamily\bfseries\color{mybluei}}
    { \hspace{-3em} 
      \tikz[baseline=(a.base)]{
...
\titleformat{\subsection}
    ...
    \begin{tikzpicture}[overlay,remember picture]
      \node[fill=mybluei,inner sep=0pt,rectangle,text width=1.5cm,
        ...
        at ($ (current page.north east) + (-0cm,-1*\modulo{\thesecshift}{3} cm) $)
