...
\documentclass[fleqn,twoside]{mc}
...
\usepackage{import}
\usepackage{amsfonts}
\usepackage{wasysym}  % for xp CIRCLE
\usepackage{spalign}
\usepackage{natbib}
...
\newcommand{\supp}[1]{\href{https://stratus.elic.ucl.ac.be/users/crucifix/direct/#1}{\detokenize{#1}}}
...
% force new section no new page
\newcommand{\sectionbreak}{\clearpage\stepcounter{secshift}}

% to be replaced by official UCL colours

\usepackage[calcwidth]{titlesec}

\title{Non-linear dynamics \\ LPHYS2114 \\ 2025-2026}
\author{Michel Crucifix}
\school{Universit\'e catholique de Louvain}
\documenttype{Lecture notes}
\academicyear{2025 -- 2026}
\coursecode{LPHYS2114}
\coursetitle{Non-linear Dynamics}
...
\newcounter{secshift}
 ...
 \titleformat{\section}
  {
  %\newpage
  %\ifx\thesecshift=4\setcounter{secshift}{0}\fi
  %\Large\sffamily\bfseries\color{mybluei}}
  %\stepcounter{secshift}
  \Large\sffamily\bfseries}
      { \hspace{-3em} 
        \tikz[baseline=(a.base)]{
       \node[fill=mybluei,anchor=south west, 
             outer sep=0, draw=none,
             inner sep=.0mm,text=white,font=\Large,
      ...
      % for some reason the color title causes an color stock error

 \titleformat{\subsection}
     %{\Large\sffamily\bfseries\color{myblueii}}
     {\Large\sffamily\bfseries}
     { \hspace{-2.5em} 
       \tikz[baseline=(a.base)]{
      \node[fill=myblueii,anchor=south west, 
            outer sep=0, draw=none,
            inner sep=.0mm,text=white,font=\Large,
            text width=2.0em, align=center, 
          minimum height=8.5mm, 
           ] (a) {\thesubsection}; 
        }
    }{0em}{} %\bigskip}
 ...
 \titleformat{\subsubsection}
     %{\Large\sffamily\bfseries\color{myblueiii}}
     {\Large\sffamily\bfseries}
     { \hspace{-3.5em} 
       \tikz[baseline=(a.base)]{
      \node[fill=myblueiii,anchor=south west, 
            outer sep=0, draw=none,
            inner sep=.0mm,text=mybluei,font=\Large,
    ...
    \setlength{\cftsecnumwidth}{3em}% Set length of number width in ToC for \subsection
    \setlength{\cftsubsecnumwidth}{4em}% Set length of number width in ToC for \subsection
    \setlength{\cftsubsubsecnumwidth}{5em}% Set length of number width in ToC for \subsection
% 
    \def\subsectiontitle{}
    ...
    \renewcommand{\subsectionmark}[1]{\def\subsectiontitle{#1}}
     ...
     \begin{tikzpicture}[overlay,remember picture]
       \node[fill=mybluei,inner sep=0pt,rectangle,text width=1.5cm,
         text height=1.5cm,align=center,anchor=north east]
         at ($ (current page.north east) + (-0cm,-1*\thesecshift cm) $)
       {\rotatebox{90}{\parbox{1.5cm}{%
        \centering\textcolor{white}{\sffamily\thesubsection}}}};
       \end{tikzpicture}}
     \fancyfoot[RE]{%
       \begin{tikzpicture}[overlay,remember picture]
       \node[fill=mybluei,inner sep=0pt,rectangle,text width=1.5cm,
         text height=1.5cm,align=center,anchor=north west]
       at ($ (current page.north west) + (-0cm,-1*\thesecshift cm) $)
       {\rotatebox{90}{\parbox{1.5cm}{%
         \centering\textcolor{white}{\sffamily\thesection}}}};
       \end{tikzpicture}}
...
%% jupyter-specicific
    ...
    \newcommand{\adjustimage}[2]{\includegraphics{#2} }
...
%\renewcommand\cftafterloftitle{\twocolumns}
